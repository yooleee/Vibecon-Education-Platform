...
async def answer_query(question: str, relevant_chunks: List[str], language: str = "en") -> str:
    ...
    Args:
        ...
        language: Response language - "en" (English), "es" (Spanish), "hi" (Hindi)
    
    Returns:
        Generated answer in the specified language
    """
    try:
        ...
        language_instructions = {
            ...
            "es": "Responde en español (Spanish). Provide your entire answer in Spanish language.",
            "hi": "हिंदी में जवाब दें (Respond in Hindi). Provide your entire answer in Hindi language."
        }
...
Provide a clear, concise answer based on the lecture content. Remember: {language_instruction}"""
