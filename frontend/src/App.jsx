            ...
            <div className="container">
              ...
              >
                <div className="text-center mb-3xl">
                  ...
                  <p className="text-secondary" style={{ fontSize: '1rem', maxWidth: '600px', margin: '0 auto var(--space-xl) auto' }}>
                    Ask questions and get answers in your professor's voice
                  </p>
                  
                  {/* Chat Mode Toggle */}
                  <div className="flex justify-center gap-md mb-2xl">
                    <button
                      className={`glass-button ${chatMode === 'standard' ? 'glass-button-primary' : ''}`}
                    ...
                    <button
                      className={`glass-button ${chatMode === 'livekit' ? 'glass-button-primary' : ''}`}
                      onClick={() => setChatMode('livekit')}
                      style={{ padding: '12px 24px' }}
                    >
                      <svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
